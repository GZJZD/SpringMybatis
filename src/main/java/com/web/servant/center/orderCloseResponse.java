...
public class orderCloseResponse {
	...
	public orderCloseResponse(String typeId, int requestId, int errcode, String errmsg, double tradePrice, double tradeCommission, String tradeDate, String tradeTime) {
		this.typeId = typeId;
		this.requestId = requestId;
		this.errcode = errcode;
		this.errmsg = errmsg;
	...
	public void writeTo(TarsOutputStream _os) {
		...
		_os.write(errcode, 3);
		_os.write(errmsg, 4);
		_os.write(tradePrice, 5);
		_os.write(tradeCommission, 6);
		_os.write(tradeDate, 7);
		_os.write(tradeTime, 8);
	}
	...
	public void readFrom(TarsInputStream _is) {
		...
		this.tradePrice = _is.read(tradePrice, 5, true);
		this.tradeCommission = _is.read(tradeCommission, 6, true);
		this.tradeDate = _is.readString(7, true);
		this.tradeTime = _is.readString(8, true);
	}
